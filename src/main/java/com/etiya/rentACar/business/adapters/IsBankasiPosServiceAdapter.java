...
public class IsBankasiPosServiceAdapter implements PosService {
    ...
    IsBankasiPosService isBankasiPosService ;
    ...
    public boolean makePayment(CreditCard creditCard) {
        boolean result = isBankasiPosService.makePayment(creditCard.getCreditCardNumber(),creditCard.getExpirationDate(),creditCard.getCvv());
        return result;
    }
}
